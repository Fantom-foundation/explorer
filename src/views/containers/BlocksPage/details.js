...
import ChatTab from 'src/views/components/chat/chatTab';
            ...
            <Row>
              <Col>
                <div id="theme-tab">
                  ...
                  <TabContent
                    className="theme-nav-tab-content"
                              ...
                              <Table className="information-table">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <td>TimeStamp:</td>
                                    <td>
                                      18 mins ago (Aug-27-2018 06:05:07 AM +UTC)
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>Transactions:</td>
                                    <td>
                                      ...
                                      and{' '}
                                      <span className="text-primary">
                                        12 contract internal transactions in
                                        this block
                                      </span>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>Hash:</td>
                                    <td>
                                      0x534d9b6e781c22587e5e54fb516c153cca2ea914a0dee5f8049372a1c3f43086
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>Parent Hash:</td>
                                    <td>
                                      <span className="text-primary">
                                        0xe31ce580c928a1655ebb1dadf197f5a21ecb741301668856b5a9e846c2482368
                                      </span>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>Sha3Uncles:</td>
                                    <td>
                                      0x0b98218248431f4d47c692e87f78cec61b284ea32ff89eb3c22b77bffe956b18
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>Mined By:</td>
                                  ...
                                  <tr>
                                    <td>Block Reward:</td>
                                    <td>
                                      3.13651355500625139 Ether (3 +
                                      0.04276355500625139 + 0.09375)
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>Uncles Reward:</td>
                                    <td>
                                      1.5 Ether (1 Uncle at{' '}
                                      <span className="text-primary">
                                        >Position 0
                                      </span>
                                      )
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      ethermine-asia1-5
                                      (Hex:0x65746865726d696e652d61736961312d35)
                                    </td>
                                  </tr>
                                </tbody>
                              </Table>

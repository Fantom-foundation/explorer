...
class ModalComponent extends React.Component {
  ...
  handleClick = (event) => {
    ...
    const loginApiPromise = loginApi(email, password, {
      ...this.props,
    });
    loginApiPromise
      .then((result) => {
            ...
            >
              ...
              <Col className="px-5 py-3">
                <Form onSubmit={(event) => this.handleClick(event)}>
                  <Title
                    h2
                    className="text-center line-title"
                  ...
                  <div className="form-element form-input">
                    <input
                      ...
                      onChange={(e) =>
                        this.onUpdate('email', e.currentTarget.value)
                      }
                    />
                  ...
                  <div className="form-element form-input">
                    <input
                      ...
                      onChange={(e) =>
                        this.onUpdate('password', e.currentTarget.value)
                      }
                    />
                    <div className="form-element-bar" />
                    <label className="form-element-label" htmlFor="Password">
                      Password
                    </label>
                  </div>
                  <Button
